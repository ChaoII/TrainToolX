...
coco_weights = {
    'PPYOLOEPLUS_CSPResNet_s_COCO':
        'https://bj.bcebos.com/v1/paddledet/models/pretrained/ppyoloe_crn_s_obj365_pretrained.pdparams',
...
def get_pretrain_weights(flag, class_name, save_dir, backbone_name=None):
    ...
    if hasattr(traintoolx, 'pretrain_dir'):
        new_save_dir = traintoolx.pretrain_dir

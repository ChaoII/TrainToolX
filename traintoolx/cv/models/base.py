...
from traintoolx.utils import (seconds_to_hms, get_single_card_bs, dict2str,
...
class BaseModel:
    def __init__(self, model_type):
        ...
        self.labels = None
        self.version = traintoolx.__version__
        self.net = None
        self.optimizer = None
    ...
    def get_model_info(self):
        info = dict()
        info['version'] = traintoolx.__version__
    ...
    def train_loop(self,
        ...
        task_id = getattr(traintoolx, "task_id", "")

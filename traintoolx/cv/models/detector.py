...
import traintoolx.ppdet as ppdet
from traintoolx.ppdet.modeling.proposal_generator.target_layer import BBoxAssigner, MaskAssigner
import traintoolx
...
from traintoolx.utils.checkpoint import det_pretrain_weights_dict
    ...
    def __init__(self,
        ...
        if params.get('with_net', True):
            ...
            head_conv_feat = ppdet.modeling.PicoFeat(
                ...
                norm_type='bn',
                share_cls_reg=True, )
            loss_class = ppdet.modeling.losses.VarifocalLoss(

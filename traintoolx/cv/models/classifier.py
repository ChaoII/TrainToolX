...
from traintoolx.utils import logging, TrainingStats
from traintoolx.cv.models.base import BaseModel
from traintoolx.cv.transforms import arrange_transforms
from traintoolx.cv.transforms.operators import Resize

from traintoolx.ppcls import arch
from traintoolx.ppcls.loss import CELoss
...
class BaseClassifier(BaseModel):
    ...
    def predict(self, img_file, transforms=None, topk=1):
        ...
        prediction = float(outputs['prediction'])
